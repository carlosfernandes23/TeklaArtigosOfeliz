...
namespace TeklaArtigosOfeliz
{
    ...
    class ComunicaBaseDadosListaDuvidas
    {

        SqlConnection MiConexionArtigo = new SqlConnection("Data Source=GALILEU\\PREPARACAO;Initial Catalog=ListadeDuvidas;Persist Security Info=True;User ID=SA;Password=preparacao");

        public void ConectarBDduvida()
        {
            if (MiConexionArtigo.State == ConnectionState.Closed)
            {
                MiConexionArtigo.Open();
        ...
        public void DesonectarBDduvida()
        {
            if (MiConexionArtigo.State == ConnectionState.Open)
            {
                MiConexionArtigo.Close();
        ...
        public DataTable Procurarbdduvida(string Query)
        {
            SqlCommand MiComando = new SqlCommand(Query, MiConexionArtigo);
            SqlDataAdapter dataAdapter = new SqlDataAdapter(MiComando);
            DataTable dataTable = new DataTable();
        ...
        public List<string> Procurarbdlistduvida(string Query)
        {
            SqlCommand MiComando = new SqlCommand(Query, MiConexionArtigo);
            List<string> Result = new List<string>();
